...
def deserializeIncidentState(obj: str, cl: type[IncidentState]) -> IncidentState:
    assert cl is IncidentState, (cl, obj)

    return cast(IncidentState, getattr(IncidentState, IncidentStateJSONValue(obj).name))
